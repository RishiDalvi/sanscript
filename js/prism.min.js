            ...
            j = {
                ...
                highlightElement: function(e, t, n) {
                    ...
                    if (
                        (j.hooks.run("before-sanity-check", i),
                            ...
                            s.setAttribute("tabindex", "0"), !i.code)
                    )
                ...
                tokenize: function(e, t) {
                    ...
                    for (
                        var r = new u(),
                            s =
                            (z(r, r.head, e), !(function e(t, n, a, r, s, i) {
                                    for (var o in a)
                                                ...
                                                for (
                                                    var g,
                                                        ...
                                                        (m &&
                                                            ...
                                                            c.pattern || c),
                                                        b = r.next,
                                                        y = s; b !== n.tail && !(i && y >= i.reach); y += b.value.length, b = b.next
                                                ) {
                                                    var v = b.value;
                                                    ...
                                                    if (!(v instanceof C)) {
                                                        ...
                                                        if (m) {
                                                            ...
                                                            for (
                                                                var P = b; P !== n.tail &&
                                                                (A < w || "string" == typeof P.value); P = P.next
                                                            )
                                                                x++, (A += P.value.length);
            ...
            (Element.prototype.matches ||
                ...
                Prism.hooks.add("before-sanity-check", function(e) {
                    ...
                    o.matches(c) &&
                        ((e.code = ""),
                            o.setAttribute(u, g),
                            ((r = o.appendChild(document.createElement("CODE"))).textContent =
                                "Loading…"),
